...
public interface Duel {
   ...
   *
   * @return The user that used counter if there was a counter, otherwise {@code null}.
   * @see User
   */
  User getCounterUser();
   ...
   *
   * @return The user who choose the winner if there was already, otherwise {@code null}.
   * @see User
   */
  User getUser();
}
